      ...
      <ScrollReveal>
        ...
        <div className="prose prose-sm max-w-none text-[#172033] space-y-6">
          <section>
            ...
            <p className="text-[#667085]">The one-time trial fee (₹4,499) is non-refundable once the trial period has commenced and platform access has been provided.</p>
          </section>
          <section>
            <h2 className="text-lg font-bold text-[#172033] mb-2">Monthly Subscriptions</h2>
            <p className="text-[#667085]">Monthly subscription fees are non-refundable. You may cancel your subscription at any time through the mobile application. Cancellation takes effect at the end of the current billing period.</p>
          </section>
          <section>
