...
export default function ForBrokersPage() {
  return (
    <>
      {/* Hero */}
      <section className="section-padding bg-gradient-to-br from-[#0f1c2e] via-[#162540] to-[#1e3a5f] relative overflow-hidden">
        <div className="absolute inset-0 dot-grid opacity-[0.06]" />
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <ScrollReveal>
            <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#f97316]/20 text-[#f97316] border border-[#f97316]/30 rounded-full text-xs font-semibold tracking-wide mb-6">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-display font-bold text-white mb-6">
              ...
              <span className="text-[#f97316]">Marketed & Managed</span>{" "}
              in One Place.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#f97316] hover:bg-[#ea6c00] text-white font-semibold rounded-xl transition-all duration-200 shadow-lg active:scale-[0.98]"
              >
      ...
      {/* Important note */}
      <section className="py-6 bg-[#fff7ed] border-b border-[#fdba74]">
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-display font-bold text-[#0f1c2e] mb-4">
          ...
          <StaggerReveal className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {featureSections.map((section) => (
              <StaggerItem key={section.category}>
                <div className="bg-[#fafafa] border border-[#e2e8f0] rounded-2xl p-6 h-full hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-10 h-10 rounded-xl bg-[#0f1c2e] flex items-center justify-center">
                      <section.icon className="w-5 h-5 text-[#f97316]" />
                    </div>
                    <h3 className="font-bold text-[#0f1c2e]">{section.category}</h3>
                  </div>
