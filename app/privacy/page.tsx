      ...
      <ScrollReveal>
        ...
        <div className="prose prose-sm max-w-none text-[#172033] space-y-6">
          ...
          <section>
            ...
            <p className="text-[#667085]">For privacy-related questions, contact us at <a href="mailto:privacy@therealtybazaar.com" className="text-[#397BCF] hover:underline">privacy@therealtybazaar.com</a>.</p>
          </section>
        </div>
      </ScrollReveal>
    </article>
