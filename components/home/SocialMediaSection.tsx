    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal className="text-center mb-14">
          ...
          >
            Create Once.{" "}
            <span className="gradient-text-orange">Publish Everywhere.</span>
          </h2>
            ...
            {steps.map((step, i) => (
              ...
              >
                ...
                <div className="flex flex-col items-center shrink-0">
                  <div className="w-10 h-10 rounded-xl bg-[#0f1c2e] flex items-center justify-center shadow-sm">
                    <step.icon className="w-5 h-5 text-[#f97316]" />
                  </div>
                  {i < steps.length - 1 && (
                    <div className="w-0.5 h-5 bg-[#e2e8f0] mt-1" />
                  )}
                </div>

                {/* Step content */}
                <div className="flex-1 bg-white border border-[#e2e8f0] rounded-xl px-4 py-3 shadow-sm">
                  <div className="font-bold text-sm text-[#0f1c2e]">{step.label}</div>
          ...
          <ScrollReveal direction="left" delay={0.2}>
            <div className="bg-white border border-[#e2e8f0] rounded-2xl overflow-hidden shadow-md">
              ...
              <div className="flex items-center gap-2.5 px-4 py-3 border-b border-[#e2e8f0]">
                ...
                <div>
                  <div className="text-sm font-bold text-[#0f1c2e]">rajesh.properties</div>
                  <div className="text-[10px] text-[#64748b]">Vesu, Surat · Sponsored</div>
                </div>
                <div className="ml-auto">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 fill-[#0f1c2e]" aria-hidden="true">
              ...
              {/* Property image */}
              <div className="aspect-square bg-gradient-to-br from-[#1a2e48] to-[#3a6496] relative">
              ...
              <div className="px-4 pt-3 pb-4">
                <p className="text-xs text-[#0f1c2e] leading-relaxed">
                  ...
                  <span className="text-blue-500"> #VesuSurat #3BHK #SuratRealEstate #DreamHome #PropertyForSale</span>
                </p>
                <div className="mt-2 text-[10px] text-[#94a3b8]">Generated by Realty AI · Published via The Realty Bazaar</div>
              </div>
            </div>
          </ScrollReveal>
        </div>
