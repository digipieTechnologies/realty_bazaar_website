...
const steps = [
  {
    ...
    icon: "🏠",
    color: "bg-[#EAF3FF] border-[#6FA5E5]/30",
    accent: "text-[#397BCF]",
  },
  {
    number: "02",
    ...
    icon: "✨",
    color: "bg-[#F3F8FE] border-[#397BCF]/20",
    accent: "text-[#397BCF]",
  },
  {
    number: "03",
...
export default function BrokerWorkflow() {
  ...
  return (
    ...
    >
      {/* Background accent */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#E4EAF2] to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {steps.map((step, i) => (
            ...
            >
              ...
              {i % 4 !== 3 && (
                <div className="absolute -right-2.5 top-1/2 -translate-y-1/2 w-5 h-5 rounded-full bg-white border-2 border-[#E4EAF2] flex items-center justify-center z-10 hidden lg:flex">
        ...
        <ScrollReveal className="mt-12 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#F3F8FE] border border-[#E4EAF2] rounded-xl mb-8">
