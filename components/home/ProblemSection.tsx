...
const chaosItems = [
  ...
  { label: "Property Photos", icon: "🏠", color: "bg-purple-50 border-purple-200 text-purple-700" },
  { label: "Sticky Notes", icon: "📝", color: "bg-orange-50 border-orange-200 text-orange-700" },
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-white border border-[#e2e8f0] rounded-xl text-sm text-[#0f1c2e] font-medium shadow-sm"
                  >
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-[#0f1c2e] to-[#1a2e48] rounded-2xl p-5 text-white text-center"
              >
                <div className="w-10 h-10 rounded-xl bg-[#f97316] flex items-center justify-center mx-auto mb-3">
                ...
                <div className="mt-3 flex justify-center gap-4 text-xs">
                  <div className="text-center">
                    <div className="text-[#f97316] font-bold text-lg">All</div>
                    <div className="text-white/50">Leads</div>
                  </div>
                  <div className="w-px bg-white/10" />
                  <div className="text-center">
                    <div className="text-[#f97316] font-bold text-lg">One</div>
                    <div className="text-white/50">Platform</div>
                  </div>
                  <div className="w-px bg-white/10" />
                  <div className="text-center">
                    <div className="text-[#f97316] font-bold text-lg">Zero</div>
